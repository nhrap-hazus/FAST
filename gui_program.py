...
rasters = [f for f in listdir(cwd) if isfile(join(cwd, f)) and f.endswith(('.tif','.tiff'))]# Search rasters folder for all .tif files and make a listprint('Rasters selection ',rasters)
